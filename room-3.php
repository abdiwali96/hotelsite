...
<body class="others">
  ...
  <div class="menu">
      ...
      <a href="rooms.php" style="padding: 14px 16px;">GALLARY</a>
      <a href="about.php" style="padding: 14px 16px;">ABOUT</a>
 ...
 <div class="row">
   <div class="column2">
     <div class="card">
       <div class="section" style="max-width:4000px"><img class="mySlides" src="images/roomselect/king/main-king.jpeg" style="width:100%">
   ...
   <h4>
    <p style="text-align: left">
        This is a luxury King room in the heart of London! Incredible views, Stunning Food and at an affordable price. We have top quality furniture that will not dissapoint! SO WHAT ARE YOU WAITING FOR! <br><br>
     </p>
